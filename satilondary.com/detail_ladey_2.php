...
<body>
    ...
    <div class="small-container detail-1">
        <div class="row">
            <div class="col-2">
                <img src="images/0_Woman-holding-huge-pile-of-clothes-laundry-concept.jpg"width="100%">
            </div>
            <div class="col-2">
            <form action="manage_card.php" method="POST">
                <p>ladies Pant & Jeans</p>
                <h1>ladies Pant & Jeans</h1>
                <p>Rs.10/one<p>
                <select>
                ...
                <input type="hidden" name="item_name" value="ladies Pant & Jeans">
